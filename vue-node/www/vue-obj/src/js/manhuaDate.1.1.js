...
$(function() {
	$.fn.manhuaDate = function(options) {
		...
		if($("#calender").length<=0){
			$("body").prepend("<div class='calender'><div class='calenderContent'><div class='calenderTable'><div class='getll'>选择时间</div><div class='getyear'><a class='preMonth' id='preMonth'></a><select id='year'></select><select id='month'></select><a class='nextMonth' id='nextMonth'></a></div><div class='tablebg'><table id='calender' class='calendertb' cellpadding='0' cellspacing='1' style='border-collapse: separate;border-spacing: 1;'><tr bgcolor='#fff'><th class='weekend'>日</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th class='weekend noborder'>六</th></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2 noborder'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr><tr><td class='weekend2'></td><td></td><td></td><td></td><td></td><td></td><td class='weekend2'></td></tr></table></div></div></div></div>");	
		}
		var $mhInput = $(this);
		...
		//下一个月的点击事件
		 ...
		 function ManhuaDate(year, month, week, lastday) {
			...
			for (var j = week; j < 7; j++) {
				...
				table.rows[1].cells[j].setAttribute("data-time", year + "-" + month + "-" + n );
			...
			for (var i = 2; i < 7; i++) {
				for (j = 0; j < 7; j++) {
					if (n > lastday) {
						...
						table.rows[i].cells[j].setAttribute("data-time", year + "-" + month + "-" + n );
		...
		$mhInput.live(options.Event,function(e){											
			...
			var iof = $(this).offset();
			$(".calender").css({ "right" : options.Left,"top" : iof.top+options.Top });
			$(".calender").show();	
		});		
		//当鼠标离开控件上面的时候延迟3秒关闭
...
function setRedDate(){
	for(var i=0;i<$("#calender td").length;i++){
		//$("#calender td").css("border","1px #CCCCCC solid")
	}
	var dateTime = $("#dateTime").attr("date-time").split(",");
	for(var i=0;i<$("#calender td").length;i++){
		for(var j=0; j<dateTime.length;j++){
			if(dateTime[j] == $("#calender td").eq(i).attr("data-time")){
				console.log(dateTime[j]+"="+$("#calender td").eq(i).attr("data-time"));
				//$("#calender td").eq(i).css("border","1px solid red");
			}
		}
	}
}